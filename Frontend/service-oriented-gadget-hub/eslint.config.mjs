					...
					paths: [
						{
							...
							message:
								"Do NOT import from '@ant-design/icons'. Use '@ant-design/icons/es/icons' instead.",
						},
					],
					patterns: [
						{
							group: ['!@ant-design/icons/es/icons'],
							message: "Only import AntD icons from '@ant-design/icons/es/icons'.",
						},
					],
				},
			],
