...
export const Navbar: React.FC = () => {
  ...
  /* ===========================
     AUTH LOADING GUARD
     Prevents null-user crashes
  ============================ */
  if (isLoading) {
    return (
      <nav className="h-16 border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900" />
    );
  }
  ...
  const navLinks = [
    ...
    { name: 'Products', path: '/distributor/products', roles: ['distributor'] },
