    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
            ...
            {quotations.map((quote) => {
                ...
                const bestPrice = quote.responses.length > 0
                    ? Math.min(...quote.responses.map(r => r.unitPrice))
                    : 0;
                                            ...
                                            {quote.responses.map((response, idx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td className={`px-6 py-4 ${isBestPrice ? 'font-bold text-green-600 dark:text-green-400' : ''}`}>
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${response.stock >= quote.quantity
