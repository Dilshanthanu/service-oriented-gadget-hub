...
// Mock data
const mockRequests = [
    { id: 1, product: 'iPhone 14 Pro Max', quantity: 50, requester: 'GadgetHub Stock', status: 'Pending', date: '2023-10-05' },
    { id: 2, product: 'MacBook Air M2', quantity: 10, requester: 'GadgetHub Stock', status: 'Responded', date: '2023-10-04' },
];
